...
ifeq ($(CONFIG),Debug)
  ...
  LDDEPS :=
  RESFLAGS := -D "DISTRHO_PLUGIN_TARGET_VST=1" -D "JucePlugin_Build_AU=0" -D "JucePlugin_Build_LV2=0" -D "JucePlugin_Build_RTAS=0" -D "JucePlugin_Build_VST=1" -D "JucePlugin_Build_Standalone=0" -D "LINUX=1" -D "BINTYPE="Linux-VST"" -D "USE_DROWAUDIO=1" -D "DEBUG=1" -D "_DEBUG=1" -D "CONFIGURATION="Debug"" -I "../source" -I "../../../libs/juce/source" -I "../../../libs/juce/source/modules" -I "../../../libs/drowaudio/source" -I "../../../libs/juced/source" -I "../../../libs/juce-plugin" -I "../../../sdks/vstsdk2.4" -I "../../drowaudio-common"
  TARGET := HiReSam_debug.so
 BLDCMD = $(CXX) -o $(OUTDIR)/$(TARGET) $(OBJECTS) $(LDFLAGS) $(LDFLAGS) $(RESOURCES) $(TARGET_ARCH)
endif

OBJECTS := \
	$(OBJDIR)/BinaryData.o \
	$(OBJDIR)/SpectrumProcessor.o \
	$(OBJDIR)/SpectrumViewer.o \
	$(OBJDIR)/SamWithBubble.o \
	$(OBJDIR)/SpectrumAnalyserAudioProcessor.o \
	$(OBJDIR)/SpectrumAnalyserAudioProcessorEditor.o \
...
$(OBJDIR)/SpectrumProcessor.o: ../source/SpectrumProcessor.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/SpectrumViewer.o: ../source/SpectrumViewer.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/SamWithBubble.o: ../source/SamWithBubble.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/SpectrumAnalyserAudioProcessor.o: ../source/SpectrumAnalyserAudioProcessor.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/SpectrumAnalyserAudioProcessorEditor.o: ../source/SpectrumAnalyserAudioProcessorEditor.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
